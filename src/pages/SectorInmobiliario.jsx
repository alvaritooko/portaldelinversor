    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: "url(https://res.cloudinary.com/dyybobphi/image/upload/v1761513253/pasaporte_hero_kq9mcq.jpg)",
          }}
        >
...
export default SectorInmobiliario;
